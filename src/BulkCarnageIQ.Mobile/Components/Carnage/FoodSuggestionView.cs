...
{
    public class FoodSuggestionView : MaterialCardView
    {
        private FoodItemSuggestion _currentFood;
        private UserProfile _currentUserProfile;
        private MacroSummary _macroSummary;

        public FoodSuggestionView(Context context, MacroSummary macroSummary, UserProfile currentUserProfile) : base(context)
        {
            _currentFood = null;
        ...
        public void Bind(FoodItemSuggestion item)
        {
            RemoveAllViews();
            _currentFood = item;
